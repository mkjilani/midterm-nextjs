    ...
    return (
       <div id="Skills" className="p-20 flex flex-col items-center justify-center">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-around gap-10">
            ...
            <img height={250} width={250} className="flex items-center justify-center rounded-3xl p-1 " src={img3} alt="" />
            <img height={250} width={250} className="flex items-center justify-center rounded-3xl p-1 " src={img4} alt="" />
        </div>
       </div>
    );
};

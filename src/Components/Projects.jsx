...
const Projects = () => {
    return (
        <div id="Projects" className="p-20 flex flex-col items-center justify-center">
            <h1 className="text-[52px] font-semibold mb-20 leading-normal uppercase text-blue-500">Projects</h1>
            <div className="flex justify-between">
               <div className="w-1/3 p-4 bg-blue-100">
                <h2 className="text-lg font-semibold mb-4 text-blue-500">Windows 2008</h2>
                ...
                <h2 className="text-lg font-semibold mb-4 text-blue-600">Database Upgrades</h2>
                ...
                <h2 className="text-lg font-semibold mb-4 text-blue-600">Data Visualizations</h2>
